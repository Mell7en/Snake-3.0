...
int main()
{
   ...
   //Ставим картнинку titels
    Texture t;
    t.loadFromFile("C:\\Users\\Взрослая академия\\Desktop\\Snake 3.0\\Photo\\Snake\\Paint\\tiles.png");
    Sprite tiles(t);
    ...
    Texture ap;
    ap.loadFromFile("C:\\Users\\Взрослая академия\\Desktop\\Snake 3.0\\Photo\\Snake\\Paint\\apple.png");
    Sprite apple(ap);

    //Ставим надпись gameover
    Texture go;
    go.loadFromFile("C:\\Users\\Взрослая академия\\Desktop\\Snake 3.0\\Photo\\Snake\\Paint\\gameover.png");
    Sprite gameover(go);
